%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%                                                                       %
% Profile likelihood for all possible 2-day experimental protocols      %
% Authors: Jana Gevertz and Irina Kareva. Last revision: 3/2/2023       %
...
%      all possible combinations of sampling 2 time points              %
%    - Plot of all profiles (each possible combination of 2 sampled     %
...
%   profile likelihood curve. Run time: @6.75h                          %
%                                                                       %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
size_sample = 2; 
v = 2:1:Tmax+1;
% All possible pairwise samplings (random integers between 2 and 31. Index = N
% corresponds to day = N - 1)
t_sample = nchoosek(v,2); 
